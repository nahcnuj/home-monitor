...
import { chartRegionsPlugin, errorBandLabelsPlugin, violinTimeSeriesPlugin } from "./charts/plugins.ts";
...
Chart.register(...registerables, chartRegionsPlugin, violinTimeSeriesPlugin, errorBandLabelsPlugin);

...
/** Ranges at or below this use a wider, horizontally scrollable latency chart. */
export const SCROLLABLE_CHART_MAX_RANGE_SEC = 24 * HOUR_SEC;
/** Horizontal density for scrollable latency charts (CSS px per hour of range). */
export const SCROLLABLE_CHART_PX_PER_HOUR = 100;
export const SCROLLABLE_CHART_PX_PER_HOUR_COMPACT = 56;
